...
* $L_{tij}$ 为从时间点 $Y_t$ 的 $i$ 等级转换至时间点 $Y_{t+1}$ 的 $j$ 等级的像元个数。
...
[1]佟斯琴,包玉海,张巧凤,都瓦拉.基于像元二分法和强度分析方法的内蒙古植被覆盖度时空变化规律分析[J].生态环境学报,2016,25(05):737-743.DOI:10.16258/j.cnki.1674-5906.2016.05.002.
